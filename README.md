...
- **실시간 감지** — 서버 YOLOv8 추론으로 2~10차선 건너편 신호등 자동 탐지
...
- [x] 카메라 시작 전 설정 화면
- [x] 디버그 녹화 (.webm)
- [x] 신호등 색상 판별 (배경 간판 오판 방지 강화 v0.3)
- [ ] 신호등 색상 판별 정확도 추가 개선 (서버 측 색상 분류)
- [ ] 카운트다운 타이머
- [ ] PWA 오프라인 지원
- [ ] TTS 속도·음량 사용자 조절
- [ ] 고대비 모드·폰트 크기 설정
