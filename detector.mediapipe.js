...
// MediaPipe COCO 라벨 → 내부 cls 인덱스 매핑
const MP_LABEL_MAP = {
  'traffic light': MP_COCO_TRAFFIC_LIGHT,
  'person':        MP_COCO_PERSON,
};
...
/* ── 추론 ── */
async function runMediaPipeDetect(canvas, W, H) {
...
function parseMpResult(result, W, H) {
  ...
  return result.detections
    .map(det => {
      ...
      const x1    = bb.originX / W;
      const y1    = bb.originY / H;
